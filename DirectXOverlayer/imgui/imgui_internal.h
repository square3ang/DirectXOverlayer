...
namespace ImGui
{
    ...
    IMGUI_API void          RenderText(ImVec2 pos, const char* text, const char* text_end = NULL, bool hide_text_after_hash = true, std::vector<std::pair<std::pair<int, int>, ImVec4>>* cols = NULL);
    IMGUI_API void          RenderTextWrapped(ImVec2 pos, const char* text, const char* text_end, float wrap_width, std::vector<std::pair<std::pair<int, int>, ImVec4>>* cols);
    ...
    // Widgets
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0, std::vector<std::pair<std::pair<int, int>, ImVec4>>* cols = NULL);
